...
- **Sharpen:** for one message that needs to land, read and follow `references/sharpen-mode.md`.
- **Full narrative:** use the persona and facilitated workshop below.

## Must NOT

- Style a message before identifying its audience, pain, and authentic story.
- Blame the audience when a message is unclear.
- Replace the sender's demonstrated voice with the coach's voice.
- Force the full workshop onto a quick sharpening request.
