...
Usage:
    python3 generate_excalidraw.py --spec '{"title":"My Diagram",...}' --output diagram.excalidraw
    echo '{"title":"My Diagram",...}' | python3 generate_excalidraw.py --output diagram.excalidraw
    python3 generate_excalidraw.py --spec-file spec.json --output diagram.excalidraw
