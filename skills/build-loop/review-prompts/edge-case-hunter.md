...
If the diff removed or replaced meaningful code (ignore pure renames and whitespace): read `references/deletion-check.md` — the launching message names its absolute path — and follow it.

### Step 5: Claims Check

Read `references/claims-check.md` — the launching message names its absolute path — and follow it.
