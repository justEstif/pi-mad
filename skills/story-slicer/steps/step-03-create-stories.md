...
- 💾 Append epics and stories to the output `epics.md` following template
...
Load `epics.md` and review:

- Approved epics_list from Step 2
- FR coverage map
- All requirements (FRs, NFRs, technical, **UX Design requirements if present**)
...
- Any NFRs, technical requirements, or UX Design Requirements relevant to this epic
...
- Append it to `epics.md` following template structure
...
- **Confirm all UX Design Requirements (UX-DRs) are covered by at least one story** (if a UX document was an input)
- Check formatting consistency

## TEMPLATE STRUCTURE COMPLIANCE:

The final `epics.md` must follow this structure exactly:

1. **Overview** section with project name
2. **Requirements Inventory** with all subsections populated
...
- IF C: Save content to `epics.md`, update frontmatter, then read fully and follow: `steps/step-04-final-validation.md`
