...
- Does a technical document specify a starter template?
...
When C is selected, the workflow is complete and `epics.md` is ready for development — hand it to the implementing agent or dev-loop flow of the user's choice.

Epics and Stories complete. Offer to answer any questions about the Epics and Stories.
