...
- 💾 Update {{epics_list}} in the output `epics.md`
...
- **Technical and UX Requirements:** Review technical and UX requirements that need to be addressed
...
After approval, update `epics.md`:
...
- IF C: Save approved epics_list to `epics.md`, update frontmatter, then read fully and follow: `steps/step-03-create-stories.md`
...
ONLY WHEN C is selected and the approved epics_list is saved to document, will you then read fully and follow: `steps/step-03-create-stories.md` to begin story creation step.
