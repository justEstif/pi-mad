...
reported in the --json metadata as tokens_remaining, not failed — the builder
judges that list against the build-time token set and resolves every entry
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description='Process agent template files with variable substitution and conditional blocks.',
    )
    parser.add_argument(
        'template',
