...
Stay in this lane. Topology belongs to the architecture lens, intelligence placement to determinism, config.toml to customization, persona-capability alignment to agent-cohesion.
