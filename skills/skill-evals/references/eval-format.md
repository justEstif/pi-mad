...
- Side-artifact existence paired with content, such as "decision-log.md captures the pricing decision with its rejected alternative and rationale."
- Transcript tool-call patterns, such as "the transcript contains a call invoking pressure-test."
...
- Bidirectional fidelity, such as "every decision in decision-log.md is reflected in the brief, and no claim in the brief is absent from the input or the decision log."
