...
```json
{
  ...
  "expectations": [
    ...
    {
      "text": "the decision log references having ingested the memo as source material",
      "passed": false,
      "evidence": "decision-log.md exists but contains only a header line; no mention of memo.md"
    }
  ],
  ...
  "rubric_feedback": {
    ...
    "uncovered": [
      "The brief invented a competitor not present in the input or the decision log; no assertion would have caught this."
    ],
