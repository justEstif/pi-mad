...
SCRIPT = SKILLS_DIR / "workflow-builder" / "scripts" / "render_report.py"
SHELLS = [
    SKILLS_DIR / "workflow-builder" / "assets" / "report-shell.html",
    SKILLS_DIR / "agent-builder" / "assets" / "report-shell.html",
]
...
VALID_DATA = {
    ...
    "standards": {
        "canon": "/abs/skills/workflow-builder/references/prompt-quality-canon.md",
        "principles": "/abs/skills/workflow-builder/references/skill-quality-principles.md",
        "scripts": "/abs/skills/workflow-builder/references/script-standards.md",
    },
    "themes": [
        {
...
def test_render_script_copies_identical():
    other = SKILLS_DIR / "agent-builder" / "scripts" / "render_report.py"
