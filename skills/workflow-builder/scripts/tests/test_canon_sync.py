...
CANON_COPIES = [
    SKILLS_DIR / "workflow-builder" / "references" / "prompt-quality-canon.md",
    SKILLS_DIR / "agent-builder" / "references" / "prompt-quality-canon.md",
    SKILLS_DIR / "agent-builder" / "assets" / "prompt-quality-canon.md",
]
